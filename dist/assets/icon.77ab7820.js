import{ar as l,cu as h,cv as o,cw as e,cx as n,cy as p,cz as i,cA as m,cB as f,cC as d,cD as F,cE as v,cF as E,cG as u,cH as M}from"./index.773a1bd1.js";import{d as H,f as B,g as I,h as V}from"./index.2f4868b2.js";import{j as x}from"./useTitle.32c855a6.js";import{I as A}from"./Layout.87c0a7e4.js";import{a as k}from"./index.e438ccbf.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function z(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function U(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":f,"zip,gz,rar,7z,tar,jar,xz":d,apk:A,db:H,md:F,epub:B,iso:I,m3u8:i,"doc,docx":v,"xls,xlsx":E,"ppt,pptx":u,pdf:M,psd:z,ai:D,url:V,cast:k},Z=(a,t)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case c.FOLDER:return x;case c.VIDEO:return i;case c.AUDIO:return p;case c.TEXT:return n;case c.IMAGE:return e;default:return o}},G=a=>Z(a.type,h(a.name));export{U as A,c as O,G as g};
